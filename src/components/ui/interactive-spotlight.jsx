...
export function InteractiveSpotlight({
  className,
  size = 100, // Minimal size as requested
  springOptions = { bounce: 0, stiffness: 100, damping: 20 },
}) {
  ...
  useEffect(() => {
    if (containerRef.current) {
      ...
      if (parent) {
        ...
        // overflow hidden removed to let it trail slightly if needed, or keep if preferred.
